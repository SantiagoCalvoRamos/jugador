...
procedure fallo1(var error1:boolean;var otro:hacer;nombre:paquete);
begin
	error1:=true;
...
procedure opcionesconsola(var opcion:hacer);
	var
		mediador:paquete;
		error:boolean;
	begin
...
procedure nohaycartas(sihaber:haber);
	begin
		case sihaber of
		nohay:
			begin
