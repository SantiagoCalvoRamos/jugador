...
procedure echarpalo(var palo:palos;var valor:valores;var vacio:boolean);
	var
		nuevos,penultimo,ultimo,primero,a_borrar:tipopuntero;
	begin
...
procedure recoger_carta(var palo:palos;var valor:valores);
var
	nuevos,ultimo,primero:tipopuntero;
begin
...
procedure echar_carta(var palo:palos;var valor:valores;var vuelta:boolean);
 begin
   vuelta:=true;
...
begin
   ...
   case opcion of
    recoger  : recoger_carta(palo,valor);
    listar   : listar_cartas_recogidas;                 //Lista las cartas recogidas
    echar    : echar_carta(palo,valor,vuelta);
...
begin
      iniciar; //Inicializar el almacenamiento de cartas recogidas
      vaciar;  //Inicializar el almacenamiento de cartas echadas
      repeat
          palo:=copas;
	  valor:=rey;
